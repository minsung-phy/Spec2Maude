...
const { tract_dot_lane0, tract_mismatch, fixed_mismatch } = instance.exports;

let mismatchCount = 0;
let firstMismatch = -1;
for (let b = 0; b < 256; ++b) {
  if (tract_mismatch(b) !== 0) {
    mismatchCount += 1;
...
console.log(`lane0_b127=${tract_dot_lane0(127)}`);
console.log(`lane0_b128=${tract_dot_lane0(128)}`);
console.log(`lane0_b255=${tract_dot_lane0(255)}`);

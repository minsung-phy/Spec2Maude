...
val materialize_iter_premise_list_bool :
  ...
  Maude_ir.generated list
val materialize_iter_premise_list_rule :
  Helper_registry.entry ->
  Helper_request.iter_premise_list_rule ->
  Maude_ir.generated list
val materialize_iter_premise_zip_binding :
  Helper_registry.entry ->
  Helper_request.iter_premise_zip_binding ->
  Maude_ir.generated list
val materialize_iter_premise_exists_bool :
  Helper_registry.entry ->
  Helper_request.iter_premise_exists_bool ->
  Maude_ir.generated list
val materialize_iter_premise_exists_rule :
  Helper_registry.entry ->
  Helper_request.iter_premise_exists_rule ->
  Maude_ir.generated list
val materialize_iter_premise_zip_bool :
  Helper_registry.entry ->
  Helper_request.iter_premise_zip_bool ->
  Maude_ir.generated list
val materialize_iter_premise_zip_rule :
  Helper_registry.entry ->
  Helper_request.iter_premise_zip_rule ->
  Maude_ir.generated list

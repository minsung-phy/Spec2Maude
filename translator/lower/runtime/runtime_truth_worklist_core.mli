...
val positive_worker_op : item -> string -> string
...
val reserve_names :
  Expr_env.t -> string list -> Maude_ir.term list -> Local_name.t
...
val positive_phase_surface : item -> Maude_ir.generated list
...
val positive_dispatcher : item -> relation -> Maude_ir.generated list

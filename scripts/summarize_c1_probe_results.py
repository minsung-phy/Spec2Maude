...
PROBES: list[Probe] = [
    ...
    ("KNOWN_STUCK", "val-ok-empty-sequence", "Val-ok(fib-store, eps, eps)", "result Judgement: Val-ok(fib-store, eps, eps)"),
    ("KNOWN_STUCK", "val-ok-multi-sequence", "Val-ok(fib-store, CTORCONSTA2(CTORI32A0, 5)", "result Judgement: Val-ok(fib-store, CTORCONSTA2"),

...
Use `limitation.md` as the single current summary of C1 limitations and
remaining debt. The many files under `docs/c1-*` are detailed audit evidence,
not required reading for ordinary continuation work.

Minimal reading order:

1. `limitation.md`: current truth for limitations and accepted/deferred debt.
...
is archived at `docs/validation_281_summary.md`; the current limitation summary
is `limitation.md`.
...
- `limitation.md`: single current summary of strict C1 limitations and
  documented executable debt.
- `docs/validation_281_summary.md`: archived strict validation-lowering
  coverage summary.
